...
`yarn install` <p> para instalar todas as dependências. </p>

`yarn dev` <p> Start no backend em localhost: 3333 </p>

<p> Você pode usar o insominia para postar, se o frontend não for iniciado </p>
<p> Para ver os dados no banco de dados, use o beekeeper Studio </p>
